...
public class WorkGiver_Warden_BreakWill : WorkGiver_Warden
{
    public override Job JobOnThing(Pawn pawn, Thing target, bool forced = false)
    {
        ...
        var prisonerCanReceiveBeating =
            interactionMode == PrisonerInteractionModeDefOf.ReduceWill && !pawn2.Downed;
        ...
        var breakJob = JobMaker.MakeJob(BeatPrisonersDefOf.CM_Beat_Prisoners_Job_Break_Will, target);
