...
public class JobDriver_BreakWill : JobDriver
{
    ...
    protected override IEnumerable<Toil> MakeNewToils()
    {
        ...
        {
            Messages.Message("CM_Beat_Prisoners_BreakWill_Attempt".Translate(pawn, Victim), Victim,
        ...
        yield return breakWill(TargetIndex.A);
        ...
        var toil = new Toil
        {
            initAction = delegate
            {
                beater.interactions.TryInteractWith(talkee,
                    BeatPrisonersDefOf.CM_Beat_Prisoners_Interaction_Prisoner_Threatened_Will);
            },
    ...
    private static Toil breakWill(TargetIndex recruiteeInd)
    {
        var toil = new Toil();
        toil.AddFinishAction(delegate
        {
            ...
            var intDef = BeatPrisonersDefOf.CM_Beat_Prisoners_Interaction_Prisoner_Beating_Will_Conclusion;
